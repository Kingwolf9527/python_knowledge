...
# 需要调用的app包名
desired_capability['appPackage'] = 'com.autonavi.minimap'
#设置超时时间
desired_capability['newCommandTimeout'] = '3000'
# 需要调用的app的launcher-activity
desired_capability['appActivity'] = 'com.autonavi.map.activity.SplashActivity'
# 保持回话,这个参数比较重要，决定是否重置会话
desired_capability['noReset'] = 'false'
# 安装app
desired_capability['app'] = r'D:\appium_apk_test\gaodeditu.apk'
...
#点击"同意"按钮
driver.find_element_by_id('com.autonavi.minimap:id/agree').click()
time.sleep(5)
...
#点击"进入地图"
driver.find_element_by_id('com.autonavi.minimap:id/button_startMap').click()
driver.implicitly_wait(3)

#在弹出框的语音助手中，点击"暂不体验"
driver.find_element_by_android_uiautomator('new UiSelector().text("暂不体验")').click()
