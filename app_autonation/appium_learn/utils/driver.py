...
from appium_learn.config_parser.read_configparser import Config_paser
...
class Driver(object):
    ...
    def read_caps(self):
        ...
        desired_caps['udid'] = self.cf.get_selectoin('capability','udid')
        ...
        desired_caps['app'] = self.cf.get_selectoin('capability','app')
